...
def generatePass(includeSpecials:bool = True, defaultLength: int = 10, showStats: bool=False):
    output=""
    ...
    print(f"Brake time : {round(totalPossibilities/(10000*60*60*24*365*100)):,} centuries at 10,000 try/second.\n") if showStats else 0
...
def help():
    ...
    Usage : 
        ...
        Without any options generates a 10 chars password including one special char
    """)
